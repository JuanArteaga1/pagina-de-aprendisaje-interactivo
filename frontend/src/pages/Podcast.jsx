...
const Podcast = () => {
  ...
  const episodios = [
    { id: 1, titulo: "Episodio 1", descripcion: "Introducción al aprendizaje", imagen: "/img/podcast.jpg", audio: "/audio/episodio1.mp3" },
    { id: 2, titulo: "Episodio 2", descripcion: "Técnicas avanzadas", imagen: "/img/podcast.jpg", audio: "/audio/episodio2.mp3" },
    { id: 3, titulo: "Episodio 3", descripcion: "Casos de éxito", imagen: "/img/podcast.jpg", audio: "/audio/episodio3.mp3" },
  ];
